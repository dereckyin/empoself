...
class AccessToken {
    ...
    public function insert($user_id, $token, $ip, $user_agent) {
        $stmt = $this->db->prepare("INSERT INTO auth_token (user_id, token, ip_address, user_agent) VALUES (:user_id, :token, :ip_address, :user_agent)");
